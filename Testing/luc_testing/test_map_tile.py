...
class MapTileTest(unittest.TestCase):
    ...
    def test_get_door_dict(self):
        self.assertEqual(self.test_initial_maptile.get_doors(), {'down': True, 'left': False, 'right': False, 'up': True})

    def test_rotate_tile_left(self):
        self.test_initial_maptile.rotate_tile_left()
        self.assertEqual(self.test_initial_maptile.get_doors(), {'down': False, 'left': True, 'right': True, 'up': False})
